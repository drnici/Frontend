...
Die Icons sind <a href="../assets/files/05_5.zip" download>hier</a> oder [hier](../assets/files/09_html) hinterlegt. <br>
![asset](../assets/images/rtm_home_page.png)   

### Header
![asset](../assets/images/rtm_header.png)   
...
### Linke Sidenav
![asset](../assets/images/rtm_left_sidenav.png)
|Was|Farbe|Logo|Grösse|Hover Farbe|
|--------|--------|--------|--------|--------|
...
### Rechte Sidenav
![asset](../assets/images/rtm_right_sidenav.png)
|Was|Farbe|Logo|Grösse|Hover Farbe|
|--------|--------|--------|--------|--------|
...
### Content
![asset](../assets/images/rtm_content.png)
|Was|Farbe|Logo|Grösse|Hover Farbe|
|--------|--------|--------|--------|--------|
